...
my %circles;
$str = 'rsm1';
print "==========================\nABOUT to look for some CIRCLES......\n";
$char_cnt = 0;
...
$third_col = ceil( $lines / 2 );

#my $fourth_col = $lines - $third_col;
my $fourth_col = @fourth_col;
...
$first_col = @first_col;
$second_col = @second_col;
my $k = $first_col + $second_col;
print "k ----- $k\n";
for (my $i = $k; $i < $lines; $i++) {
    push (@temp_col, $shortened_clue_list[$i]);
}
...
my $first_str;
while ( $third_col[0] !~ m/\s*\d+\.\s/ ) {
    $first_str = shift(@third_col);
    push(@second_col, $first_str);
}

@temp_col = ();
my $third_col = @third_col;
$k = $first_col + $second_col + $third_col;
$k--;
print "k ----- $k\n";
...
for (my $i = $k; $i < $lines; $i++) {
    push (@fourth_col, $shortened_clue_list[$i]);
}




print "fourth_col ... first el == $fourth_col[0]\n";
while ( $fourth_col[0] !~ m/\s*\d+\.\s/ ) {

    $last_str = pop(@third_col);
    unshift(@fourth_col, $last_str);
}


if (0) {
print "------------ first ------------------------\n";
foreach my $w (@first_col) {
    print $w, "\n";
}
print "------------ first ------------------------\n";

print "------------ second ------------------------\n";
foreach my $w (@second_col) {
    print $w, "\n";
}
print "------------ second ------------------------\n";

print "------------ third ------------------------\n";
foreach my $w (@third_col) {
    print $w, "\n";
}
print "------------ third ------------------------\n";

print "------------ fourth ------------------------\n";
foreach my $w (@fourth_col) {
    print $w, "\n";
}
print "------------ fourth ------------------------\n";
